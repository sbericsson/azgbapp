...
commands appear in the activity feed. Every command Codex runs will show up here
in real time."
...
> snapshot and describe this page." A child Codex instance will execute your
...
> You're all set! Chrome is under Codex's control with the Side Panel showing
> live activity and a chat sidebar for direct commands. Here's what you can do:
>
> - **Chat in the sidebar** — type natural language instructions and Codex
